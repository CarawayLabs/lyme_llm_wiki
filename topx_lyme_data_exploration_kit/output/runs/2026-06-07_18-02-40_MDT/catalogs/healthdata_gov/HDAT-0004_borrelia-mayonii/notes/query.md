...
- Retrieval URL: `https://api.us.socrata.com/api/catalog/v1?search_context=healthdata.gov&q=Borrelia+mayonii&limit=100`
- Auth alias: `HEALTHDATA_SOCRATA_APP_TOKEN`; credential sent: no
- HTTP status: `200`
- Records normalized from this page: `0`
- Raw response: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\healthdata_gov\HDAT-0004_borrelia-mayonii\raw\page_0001.json`
- JSON envelope: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\healthdata_gov\HDAT-0004_borrelia-mayonii\json\page_0001.json`
