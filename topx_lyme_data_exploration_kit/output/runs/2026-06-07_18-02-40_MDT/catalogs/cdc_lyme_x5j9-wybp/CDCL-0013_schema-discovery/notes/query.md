...
- Endpoint: `GET https://data.cdc.gov/api/views/x5j9-wybp`
- Retrieval URL: `https://data.cdc.gov/api/views/x5j9-wybp`
- Auth alias: `CDC_SOCRATA_APP_TOKEN`; credential sent: yes
- HTTP status: `200`
- Records normalized from this page: `1`
- Raw response: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cdc_lyme_x5j9-wybp\CDCL-0013_schema-discovery\raw\page_0001.json`
- JSON envelope: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cdc_lyme_x5j9-wybp\CDCL-0013_schema-discovery\json\page_0001.json`
