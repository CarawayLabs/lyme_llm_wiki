# AHRQ-0010: community-level health database
...
- Retrieval URL: `https://datatools.ahrq.gov/?asset_search_term=community-level+health+database&capture_codebook=True`
- Auth alias: `none`; credential sent: no
- HTTP status: `200`
- Records normalized from this page: `0`
- Raw response: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\ahrq\AHRQ-0010_community-level-health-database\raw\page_0001.html`
- JSON envelope: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\ahrq\AHRQ-0010_community-level-health-database\json\page_0001.json`
