# CMSD-0012: hospital quality infectious disease

- Catalog: CMS Data Catalog (`cms_data`)
- Query mode: `catalog_search`
- Priority/theme: `P1` / `treatment`
- Endpoint: `GET https://data.cms.gov/`
- Retrieval URL: `https://data.cms.gov/?catalog_search_term=hospital+quality+infectious+disease&follow_access_api_link=True`
- Auth alias: `none`; credential sent: no
- HTTP status: `200`
- Records normalized from this page: `0`
- Raw response: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cms_data\CMSD-0012_hospital-quality-infectious-disease\raw\page_0001.html`
- JSON envelope: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cms_data\CMSD-0012_hospital-quality-infectious-disease\json\page_0001.json`
