# CMSD-0005: antibiotic prescribing

- Catalog: CMS Data Catalog (`cms_data`)
- Query mode: `catalog_search`
- Priority/theme: `P1` / `treatment`
- Endpoint: `GET https://data.cms.gov/`
- Retrieval URL: `https://data.cms.gov/?catalog_search_term=antibiotic+prescribing&follow_access_api_link=True`
- Auth alias: `none`; credential sent: no
- HTTP status: `200`
- Records normalized from this page: `0`
- Raw response: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cms_data\CMSD-0005_antibiotic-prescribing\raw\page_0001.html`
- JSON envelope: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cms_data\CMSD-0005_antibiotic-prescribing\json\page_0001.json`
