# CMSD-0015: beneficiary travel distance care

- Catalog: CMS Data Catalog (`cms_data`)
- Query mode: `catalog_search`
- Priority/theme: `P1` / `care_access`
- Endpoint: `GET https://data.cms.gov/`
- Retrieval URL: `https://data.cms.gov/?catalog_search_term=beneficiary+travel+distance+care&follow_access_api_link=True`
- Auth alias: `none`; credential sent: no
- HTTP status: `200`
- Records normalized from this page: `0`
- Raw response: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cms_data\CMSD-0015_beneficiary-travel-distance-care\raw\page_0001.html`
- JSON envelope: `C:\codex_programming\lyme_llm_wiki\topx_lyme_data_exploration_kit\output\runs\2026-06-07_18-02-40_MDT\catalogs\cms_data\CMSD-0015_beneficiary-travel-distance-care\json\page_0001.json`
